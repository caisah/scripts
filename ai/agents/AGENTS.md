...
- Describe options with concrete pros/cons. Do not use persuasive or emotionally weighted wording unless asked for a recommendation.
...
## Code
- Accessibility should be considered every time.
